        ...
        while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
              ...
              echo '<tr>
                  ...
                  <td class="col-2 text-center">
                    ...
                    <button type="submit" class="btn btn-success m-1" title="Promover a ADM" id="promover" value="'.$linha['idcli'].'"><i class="mdi mdi-account-star m-1 style="color: #fff;"></i></button>
                  </td>
                </tr>';
